...
/* Uncomment following line to enable standard termcap API */
/* #define ENABLECAP 1 */
...
struct cap
 ...
 int skiptop;			/* No. of lines to skip on top of terminal */
 ...
 * 'dopadding' should be set if pad characters are to be used.
 *
...
*/
extern char *tcompile();

/* Old termcap simulation */
#ifdef ENABLECAP
