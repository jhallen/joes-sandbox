...
register int sz;
 ...
 if( sz>=16 )
#else
 if( ((s-(char *)0)&(ISIZ-1))==((d-(char *)0)&(ISIZ-1)) && sz>=16)
#endif
  {
  int z=((s-(char *)0)&(ISIZ-1));
#ifndef AUTOINC
  s-=z; d-=z;
#endif
  switch(z)
...
register int sz;
 ...
 if(sz>=16)
#else
 if( ((d-(char *)0)&(ISIZ-1))==((s-(char *)0)&(ISIZ-1)) && sz>=16 )
#endif
  {
  int z=((s-(char *)0)&(ISIZ-1));
  if(z)
...
register char *l, *r;
 ...
 while(len>=16)
  {
  if(l[0]!=r[0]) { c=0; goto done; }
  if(l[1]!=r[1]) { c=1; goto done; }
  if(l[2]!=r[2]) { c=2; goto done; }
  if(l[3]!=r[3]) { c=3; goto done; }
  if(l[4]!=r[4]) { c=4; goto done; }
  if(l[5]!=r[5]) { c=5; goto done; }
  if(l[6]!=r[6]) { c=6; goto done; }
  if(l[7]!=r[7]) { c=7; goto done; }
  if(l[8]!=r[8]) { c=8; goto done; }
  if(l[9]!=r[9]) { c=9; goto done; }
  if(l[10]!=r[10]) { c=10; goto done; }
  if(l[11]!=r[11]) { c=11; goto done; }
  if(l[12]!=r[12]) { c=12; goto done; }
  if(l[13]!=r[13]) { c=13; goto done; }
  if(l[14]!=r[14]) { c=14; goto done; }
  if(l[15]!=r[15]) { c=15; goto done; }
  l+=16; r+=16;
  len-=16;
  }
 l-=15-len; r-=15-len;
 switch(len)
  {
  case 15: if(l[0]!=r[0]) { c=0; goto done; }
  case 14: if(l[1]!=r[1]) { c=1; goto done; }
  case 13: if(l[2]!=r[2]) { c=2; goto done; }
  case 12: if(l[3]!=r[3]) { c=3; goto done; }
  case 11: if(l[4]!=r[4]) { c=4; goto done; }
  case 10: if(l[5]!=r[5]) { c=5; goto done; }
  case 9: if(l[6]!=r[6]) { c=6; goto done; }
  case 8: if(l[7]!=r[7]) { c=7; goto done; }
  case 7: if(l[8]!=r[8]) { c=8; goto done; }
  case 6: if(l[9]!=r[9]) { c=9; goto done; }
  case 5: if(l[10]!=r[10]) { c=10; goto done; }
  case 4: if(l[11]!=r[11]) { c=11; goto done; }
  case 3: if(l[12]!=r[12]) { c=12; goto done; }
  case 2: if(l[13]!=r[13]) { c=13; goto done; }
  case 1: if(l[14]!=r[14]) { c=14; goto done; }
  case 0: ;
  }
 return 0;
